...
/*	proc_create("HORclock", 0, NULL, hor_clock, NULL);
 *	proc_create_data("HORbusy", 0, NULL, hor_fct, (void*)HOR_BUSY);
 *	proc_create_data("HORsched", 0, NULL, hor_fct, (void*)HOR_SCHED);
 *	proc_create_data("HORwait", 0, NULL, hor_fct, (void*)HOR_WAIT;
 *	proc_create_data("HORschedto", 0, NULL, hor_fct, (void*)HOR_SCHEDTO);
*/
	return 0;
}
